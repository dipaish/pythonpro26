"""
Quick Start: Click Terminal > New Terminal | pwd (check location) | cd part4 (if needed)

Grade statistics

Task: In this exercise you will write a program for printing out grade statistics for a university course.
...
# Save your file and run it using: python 37_grade_statistics.py
# Check: python grade_part4.py

# Commit and push changes to GitHub:
# 1. git add .                                    (stage all changes)
# 2. git commit -m "Completed task 4.5.6"         (commit with message)
